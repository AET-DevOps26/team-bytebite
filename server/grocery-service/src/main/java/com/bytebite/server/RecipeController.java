...
public class RecipeController {
    ...
    @Operation(
            ...
            description = "Returns the caller's recipes as summaries, newest first. Use GET /{recipeId} for items.",
    ...
    public RecipeDetailDTO getById(
            @Parameter(hidden = true) @RequestHeader("X-User-Id") UUID userId,
            @Parameter(description = "Identifier of the recipe", required = true)
